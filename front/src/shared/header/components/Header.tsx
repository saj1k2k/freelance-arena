...
const Header: FC = ({navClass}): ReactElement => {
    return (
        <header>
                ...
                <div className="m-auto px-6 xl:container md:px-12 lg:px-6">
                    <div className="flex flex-wrap items-center justify-between gap-6 md:gap-0 md:py-3 lg:py-5">
                        ...
                        <div
                            ...
                            <div
                                className="border-primary/10 -ml-1 flex w-full flex-col space-y-2 dark:border-gray-700 sm:flex-row md:w-max lg:space-y-0 lg:border-l">
                                <div className="relative ml-auto flex h-9 items-center justify-center before:absolute
                            ...
                            <span className="relative text-sm font-semibold text-gray-600 dark:text-gray-300">Sign
                                In</span>
                                </div>
                                <div className="relative ml-auto flex h-9 items-center justify-center rounded-full bg-sky-500
